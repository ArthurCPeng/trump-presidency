...
#-------Audio Files-------#
crooked_audio = pygame.mixer.Sound('crooked.wav')
emails_audio = pygame.mixer.Sound('emails.wav')
taxreturns_audio = pygame.mixer.Sound('taxreturns.wav')
fakenews_audio = pygame.mixer.Sound('fakenews.wav')
stop_audio = pygame.mixer.Sound('stop.wav')
cheers_audio = pygame.mixer.Sound('cheers.wav')
impeached_audio = pygame.mixer.Sound('impeached.wav')

emergency_audio = pygame.mixer.Sound('Border/emergency.wav')
patrol_audio = pygame.mixer.Sound('Border/patrol.wav')
patrol_audio.set_volume(0.8)
lockup_audio = pygame.mixer.Sound('Border/lockup.wav')
lockup_audio.set_volume(0.40)
protest_audio = pygame.mixer.Sound('Border/protest.wav')
riot_audio = pygame.mixer.Sound('Border/riot.wav')
...
chapter1 = pygame.image.load('chapter1.png')
...
chapter2_1 = pygame.image.load('chapter2_1.png')
...
chapter2_2 = pygame.image.load('chapter2_2.png')
...
chapter2_3 = pygame.image.load('chapter2_3.png')
...
chapter2_4 = pygame.image.load('chapter2_4.png')
...
chapter3 = pygame.image.load('chapter3.png')
...
chapter4 = pygame.image.load('chapter4.png')
...
instructions3 = pygame.image.load('instructions3.png')
...
instructions4 = pygame.image.load('instructions4.png')
...
media_war = pygame.image.load('News/media_war.jpg')
media_war.convert()
...
impeach = pygame.image.load('News/impeach.jpg')
impeach.convert()
...
trump_at_border_image = pygame.image.load('Border/Pictures/trump_at_border.jpg')
...
anger_image = pygame.image.load('Border/Pictures/immigration_protest.jpg')
anger_image.convert()
anger_image.set_alpha(200)
anger_image = pygame.transform.smoothscale(anger_image, (screen_width, screen_height))

security_image = pygame.image.load('Border/Pictures/riot2.jpg')
...
mexico_image = pygame.image.load('Border/Pictures/mexico.jpg')
...
desert_image = pygame.image.load('Border/Pictures/desert3.jpg')
desert_image.convert()
desert_image = pygame.transform.smoothscale(desert_image, (screen_width, screen_height))

congress = pygame.image.load('Impeachment/congress2.jpg')
congress.convert()
...
cage_image = pygame.image.load('Border/Pictures/cage1.png')
...
trump_press1 = pygame.image.load('News/trump_conference1.jpg')
...
chair_image = pygame.image.load('chair2.png')
chair_image.convert_alpha()


cnn_image = pygame.image.load('News/cnn.png')
cnn_image.convert_alpha()
media_images.append(cnn_image)

nyt_image = pygame.image.load('News/nyt.jpg')
nyt_image.convert_alpha()
media_images.append(nyt_image)

washingtonpost_image = pygame.image.load('News/washingtonpost.jpg')
washingtonpost_image.convert_alpha()
media_images.append(washingtonpost_image)

foxnews_image = pygame.image.load('News/foxnews.jpg')
foxnews_image.convert_alpha()
media_images.append(foxnews_image)

fakenews_image = pygame.image.load('News/fakenews.png')
fakenews_image.convert_alpha()


#-------Images: Chapter 4-------#
trump3 = pygame.image.load('Impeachment/trump.png')
...
while True:
    ...
    #----------Border Patrol Arrests Immigrants---------#
    #----------Border Patrols are Blitted onto the Screen--------#
    for patrol in patrols:
...
while True:
    ...
    impeachment_progress_text = impeachment_progress_font.render('impeachment progress: '+str(impeachment_progress)+'%',True,(0,0,255))
    if impeachment_progress > 85:
        impeachment_progress_text = impeachment_progress_font.render('impeachment progress: '+str(impeachment_progress)+'%',True,(255,0,0))
